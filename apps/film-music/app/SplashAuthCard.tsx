...
/** See `apps/sounding/app/SplashAuthCard.tsx` — splash GET auth routes must not be plain links (prefetch risk). */
export default function SplashAuthCard({ loginUrl, ytUrl }: { loginUrl: string; ytUrl: string }) {
  return (

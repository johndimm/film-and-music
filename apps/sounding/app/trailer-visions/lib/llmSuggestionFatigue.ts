...
/**
 * The model returned a title the client could not use: already queued, already decided, or fatigue-blocked.
 * Counts per canonical title — used to derive an extra exclude tier (see mergeLlmDiscardFatigueIntoExcluded).
 */

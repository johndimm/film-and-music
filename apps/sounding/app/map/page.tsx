...
export default function MapPage() {
  ...
  useEffect(() => {
    ...
    function load() {
      try {
        // Channels system: history lives inside each channel in soundings storage
        const rawChannels = localStorage.getItem(soundingsStorage.channels)
        if (rawChannels) {
        ...
        // Legacy fallback
        const raw = localStorage.getItem(soundingsStorage.history)

      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <section className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 sm:p-6 space-y-3">
          ...
          <p className="text-sm text-zinc-600 leading-relaxed">
            ...
            <strong className="text-zinc-800">Help</strong>. <Link href="/trailer-visions/ratings" className="font-semibold text-zinc-800 underline-offset-2 hover:underline">Ratings</Link>{" "}
        ...
        <section className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 sm:p-6 space-y-3">
          ...
          <ul className="text-sm text-zinc-600 space-y-2 list-disc pl-5 leading-relaxed">
            <li>
              <Link href="/trailer-visions/watchlist" className="font-semibold text-zinc-800 underline-offset-2 hover:underline">
                Watchlist
              </Link>
              {" — "}
            ...
            <li>
              <Link href="/trailer-visions/ratings" className="font-semibold text-zinc-800 underline-offset-2 hover:underline">
                Ratings
              </Link>
              {" — "}
            ...
            <li>
              <Link href="/trailer-visions/channels" className="font-semibold text-zinc-800 underline-offset-2 hover:underline">
                Channels
              </Link>
              {" — "}

...
const BASE = 'https://film-and-music.vercel.app'
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-3xl mx-auto px-8 py-12">
        ...
        <p className="text-zinc-400 text-sm mb-10">Report: V.1 · Response date: May 5, 2026</p>
          ...
          <div className="mt-6">
            ...
            <div className="bg-zinc-900 rounded-xl p-5">
              <p className="text-zinc-200 leading-relaxed">
                ...
                enumerates all data the application accesses, including YouTube API Data (search queries
                and video metadata), Spotify OAuth tokens, playback preferences, and usage logs.
              </p>
              <p className="mt-3">
                <a
          ...
          <div className="mt-6">
            ...
            <div className="bg-zinc-900 rounded-xl p-5">
              <p className="text-zinc-200 leading-relaxed">
                ...
                discloses use of HTTP cookies (Spotify session token) and localStorage/sessionStorage (UI
                preferences and playback state), and notes that third-party services (YouTube, Spotify)

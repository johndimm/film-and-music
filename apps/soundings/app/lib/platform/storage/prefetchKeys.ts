import { trailerVisionStorage } from './keys'

const PREFETCH_QUEUE_PREFIX = trailerVisionStorage.prefetchQueuePrefix

/** Legacy single-queue key; migrated to per-channel keys on read. */
export const LEGACY_PREFETCH_QUEUE_KEY = PREFETCH_QUEUE_PREFIX
